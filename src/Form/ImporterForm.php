...
class ImporterForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\tracks\Entity\Importer::load',
      ],
    ...
    if ($plugin_id) {
      /** @var \Drupal\tracks\Plugin\ImporterInterface $plugin */
    ...
    $form['update_existing'] = [
      ...
      '#description' => $this->t('Whether to update existing tracks if already imported.'),
    ...
    $form['source'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Source'),
      '#description' => $this->t('The source of the tracks.'),
    ...
    $form['bundle'] = [
      ...
      '#title' => $this->t('Track type'),
      '#default_value' => $importer->getBundle() ? $this->entityTypeManager->getStorage('track_type')->load($importer->getBundle()) : NULL,
      '#description' => $this->t('The type of tracks that need to be created.'),
      '#required' => TRUE,
    ];
